...
@Client.on_message(command(["ping", "repo", "cutie", "alive"]) & filters.group & ~filters.private)
...
async def help(client: Client, message: Message):
    ...
    rahul = await message.reply_photo(
        photo=f"https://telegra.ph/file/75a3fd147cacabc5f6eb5.jpg",
        caption=" ᴩɪɴɢɪɴɢ... ",
    )
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "•✰sᴏᴜʀᴄᴇ✰•", url="https://github.com/Team-techno/misscutiemusic"
                    )
                  ]
            ]
        ),
