...
async def start_(client: Client, message: Message):
    ...
    await message.reply_photo(
        photo=f"https://telegra.ph/file/a8f18df4770b2336d7fde.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━
∆ ʜᴇʏ {message.from_user.mention()} !
        ᴛʜɪs ɪs [misscutiemusic](t.me/Misscutiemusicbot),  ɪ ᴀᴍ ᴀ ᴍᴜsɪᴄ ʙᴏᴛ, ɪ ᴄᴀɴ ᴘʟᴀʏ ᴍᴜsɪᴄ ɪɴ ʏᴏᴜʀ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ....
